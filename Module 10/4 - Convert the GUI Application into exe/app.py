...
class App(QMainWindow, Ui_MainWindow):
    ...
    def displayDatasetStats(self):
        ...
        for name, value in average_results_dic.items():
            ...
            if name.split()[-1] == 'Color':
                ...
                # Get the color name.
                color = QColor(int(value[2]), int(value[1]), int(value[0])).name()
    ...
    def displayImageStats(self):
        ...
        if hair_color_list[self.index] != None:
            ...
            hair_color = QColor(int(hair_color_list[self.index][2]),
            int(hair_color_list[self.index][1]),
            int(hair_color_list[self.index][0])).name()
        ...
        if eye_color_list[self.index] != None:
            ...
            eye_color = QColor(int(eye_color_list[self.index][2]),
            int(eye_color_list[self.index][1]),
            int(eye_color_list[self.index][0])).name()
